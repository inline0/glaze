...
let structuredData = {
  "contents": [{
    "heading": void 0,
    "content": "You can create presets for your animations by using the defaults object. This\nis useful when you want to apply the same settings to multiple animations."
  }, {
    "heading": "usage",
    "content": "Or when using classes:"
  }],
  "headings": [{
    "id": "setup",
    "content": "Setup"
...
function _createMdxContent(props) {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsxs(_components.p, {
      children: ["You can create presets for your animations by using the ", jsxRuntimeExports.jsx(_components.code, {
        children: "defaults"
      }), " object. This\nis useful when you want to apply the same settings to multiple animations."]
        ...
        children: jsxRuntimeExports.jsxs(_components.code, {
          children: [jsxRuntimeExports.jsxs(_components.span, {
            ...
            children: [jsxRuntimeExports.jsx(_components.span, {
              ...
              children: '"from:rotate-2160|duration-5"'
            }), jsxRuntimeExports.jsx(_components.span, {
              style: {
                "--shiki-light": "#24292E",
                "--shiki-dark": "#E1E4E8"
...
`
      ...
      children: "Or when using classes:"
    }), "\n", jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {
      children: jsxRuntimeExports.jsx(_components.pre, {
        className: "shiki shiki-themes github-light github-dark",
        style: {
        ...
        children: jsxRuntimeExports.jsx(_components.code, {
          children: jsxRuntimeExports.jsxs(_components.span, {
            ...
            children: [jsxRuntimeExports.jsx(_components.span, {
              ...
              children: '"animate-preset-helicopter h-20 w-20 rounded-xl bg-amber-500"'
            }), jsxRuntimeExports.jsx(_components.span, {
              style: {
                "--shiki-light": "#24292E",
                "--shiki-dark": "#E1E4E8"
